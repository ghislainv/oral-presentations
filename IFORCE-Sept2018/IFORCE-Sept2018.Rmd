...
\centering\includegraphics[height=\textheight]{figs/perc_ctry.png}

----

\centering\includegraphics[height=\textheight]{figs/Africa_map_forest_loss.png}
...
- \textcolor{green}{Greener}: lower probability
...
- \textcolor{green}{green}: residual forest in 2050
...
- Tests with `reticulate` R package to 
