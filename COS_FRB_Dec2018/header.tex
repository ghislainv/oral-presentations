...
\title[BioSceneMada]{\textbf{BioSceneMada:} Scénarios d'évolution de la biodiversité sous l'effet conjoint du changement climatique et de la déforestation à Madagascar}
%\subtitle{} 
...
\logo{\ifplacelogo\includegraphics[width=2.5cm]{figs/Logo-Cirad.png}\fi} % replace with your own command
