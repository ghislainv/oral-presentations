#+TITLE: Risk maps for carbon credit certification
...
#+BEAMER_HEADER: \title[riskmaps]{Risk maps for carbon credit certification}
...
- Dinamica EGO:
- Land Change Modeler (Clark Labs):
- CLUE-S:
- Note, in the documentation for UDef-ARP: Clark Labs plans to offer a utility to facilitate the creation of vulnerability maps for
