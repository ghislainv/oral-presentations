...
\label{sec:orgc573961}

\subsection{Improving certification methodologies}
\label{sec:org73964d8}

\begin{frame}[label={sec:org3e3dc0a}]{Several criticisms to project-based approach}
...
\begin{frame}[label={sec:orgc9ef619}]{New jurisdictional approach}
...
\label{sec:org086e3c9}

\begin{frame}[label={sec:org803574d}]{Risk map at the jurisdictional level}
\begin{columns}
...
\begin{frame}[label={sec:org02ae48c}]{Allocating deforestation to projects}
\begin{itemize}
...
\label{sec:orgf8b48f4}

\subsection{VT0007 tool}
\label{sec:orgfc92340}

\begin{frame}[label={sec:org0a8d0dc}]{VT0007 tool}
\begin{itemize}
...
\begin{frame}[label={sec:org16c04fd}]{Modelling periods}
\begin{center}
...
\label{sec:orgf26f69e}

\begin{frame}[label={sec:org1dcd546}]{Benchmark model}
\begin{itemize}
...
\begin{frame}[label={sec:org0127044}]{Distance threshold}
\begin{itemize}
...
\begin{frame}[label={sec:orge2e91a3}]{From distance to risk class}
\begin{itemize}
...
\begin{frame}[label={sec:orgf6bde33}]{Classes from subjurisdictions}
\begin{itemize}
...
\begin{frame}[label={sec:org1282671}]{Classes from subjurisdictions}
\begin{itemize}
...
\begin{frame}[label={sec:org4642af6}]{Deforestation density}
\begin{itemize}
...
\begin{frame}[label={sec:org208d202}]{Deforestation density}
\begin{table}[htbp]
\caption{\label{tab:org3a5a167}Deforestation rates for each class of deforestation risk (numbers truncated to three decimal digits).}
\small
...
\begin{frame}[label={sec:orgb247bc4}]{Deforestation density}
...
\label{sec:org38cd707}

\begin{frame}[label={sec:orgfebc5b6}]{Alternative models}
\begin{itemize}
...
\begin{frame}[label={sec:orgd78120d}]{Alternative models}
\begin{itemize}
...
\begin{frame}[label={sec:org01e07bb}]{Validation procedure}
\begin{itemize}
...
\begin{frame}[label={sec:orgff8019e}]{Validation procedure}
\begin{itemize}
...
\begin{frame}[label={sec:org5d6f488}]{Validation procedure}
\begin{itemize}
...
\begin{table}[htbp]
\caption{\label{tab:org00b197f}Performance indices.}
\small
...
\begin{frame}[label={sec:orgca6f1d4}]{Validation procedure}
\begin{center}
...
\label{sec:org580f0e0}

\subsection{Verra/Clark Labs software}
\label{sec:org4f0025a}

\begin{frame}[label={sec:org066614d}]{Verra/Clark Labs software}
\begin{center}
...
\begin{frame}[label={sec:org559796f}]{Verra/Clark Labs software}
\begin{center}
...
\begin{frame}[label={sec:orgb78c3a2}]{Limitations}
\begin{itemize}
...
\label{sec:org09b46da}

\begin{frame}[label={sec:org3ebd8bd}]{Existing software for alternative models}
\begin{itemize}
...
\label{sec:orgad7de28}

\begin{frame}[label={sec:org3804e13}]{Limitations}
\begin{itemize}
...
\begin{frame}[label={sec:org1dceab0}]{Limitations}
\begin{itemize}
...
\section{Conclusion}
\label{sec:org915e493}

\subsection{A not so simple methodology}
\label{sec:org71279ac}

\begin{frame}[label={sec:org1cd9604}]{Summary}
\begin{itemize}
...
\begin{frame}[label={sec:orgba3559d}]{A not so simple methodology}
\begin{itemize}
