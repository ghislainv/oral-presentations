...
| Country         | FRA 2015 | prim. forest | GFC30 2020 | TMF 2020 |
|-----------------+----------+--------------+------------+----------|
| PNG             |    36024 |        27200 |      39000 |    39304 |
| Solomon Islands |     2527 |         1738 |       2350 |     2739 |
...
*Forest cover estimates (in % of land area).*
...
*Mean annual deforestation (in %/yr).*
...
|-----------------+------------+------------+------------|
| PNG             |       0.09 |       0.27 |       0.12 |
| Solomon Islands |            |       0.57 |       0.06 |
| Vanuatu         |            |        0.1 |       0.05 |
| Fiji            |            |       0.25 |            |
| New Caledonia   |            |       0.12 |       0.28 |
...
** Global maps of biodiversity

*** Global maps of biodiversity

- We only consider here tree biodiversity.
- I am not aware of existing global maps of tree diversity.
...
- Dauby et al. 2016 PhytoKeys. SDMs for tree species in Africa.
- Guo et al. 2022 PNAS: SDM for 46,752 tree species from GBIF, BIEN, DRYFLOR, RAINBIO, ALA.
...
*** Tree biodiversity data in New-Caledonia
