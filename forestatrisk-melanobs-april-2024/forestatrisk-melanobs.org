...
#+BEAMER_HEADER: \title[forestatrisk]{--ForestAtRisk--\\Spatial forecasting of forest cover change in the humid tropics over the 21st century}
...
and 2220 in Asia, Africa, and America, respectively (average uncertainty of \pm45 years).
