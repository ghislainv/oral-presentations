...
\title[Controverse]{Déforestation et développement\\ des cultures pérennes}
\subtitle{Quelles relations ? Quelles perspectives ?} 
...
\logo{\ifplacelogo\includegraphics[width=0.4\textwidth]{figs/partners_logos}\fi} % replace with your own command
