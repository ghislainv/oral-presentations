...
#+BEAMER_HEADER:         \vspace{0.5cm}
#+BEAMER_HEADER:         \tableofcontents[sections=5,currentsection]
#+BEAMER_HEADER:       \end{column}
...
#+BEAMER_HEADER: }
#+BEAMER_HEADER: 
#+BEAMER_HEADER: %Call table of contents at the beginning of each subsection
...
#+BEAMER_HEADER:     \begin{columns}[c]
#+BEAMER_HEADER:       \begin{column}{0.5\textwidth}
#+BEAMER_HEADER:         \tableofcontents[sections=1,currentsection, currentsubsection]
#+BEAMER_HEADER:         \vspace{0.5cm}
#+BEAMER_HEADER:         \tableofcontents[sections=2,currentsection, currentsubsection]
#+BEAMER_HEADER:         \vspace{0.5cm}
#+BEAMER_HEADER:         \tableofcontents[sections=3,currentsection, currentsubsection]
#+BEAMER_HEADER:       \end{column}
#+BEAMER_HEADER:       \begin{column}{0.5\textwidth}
#+BEAMER_HEADER:         \tableofcontents[sections=4,currentsection, currentsubsection]
#+BEAMER_HEADER:         \vspace{0.5cm}
#+BEAMER_HEADER:         \tableofcontents[sections=5,currentsection, currentsubsection]
#+BEAMER_HEADER:       \end{column}
#+BEAMER_HEADER:     \end{columns}
#+BEAMER_HEADER:   \end{frame}
#+BEAMER_HEADER: \placelogofalse
