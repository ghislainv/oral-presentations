...
- boral by Francis K.C. Hui and JAGS by 
...
On average, jSDM is **`r ratio_speed` times faster** than boral/jags.
...
- Small data-sets, simple models: R, *BUGS, JAGS, Stan, INLA, MCMCglmm
- Large data-sets or complex hierarchical models: R $+$ Rcpp $+$ RcppGSL $+$ RcppArmadillo

The Gibbs sampler can typically be written in about half a day. Reusable. Can save you a lot of time.