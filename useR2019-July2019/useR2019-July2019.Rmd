...
\begin{block}{C++ code}
\lstinputlisting[language=C++, firstline=1, lastline=6]{Code/addition.cpp}  
\end{block}
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=1.3cm]{figs/Rcpp-logo.png}  &  \Huge{\MVArrowDown} & \large{compile and execute}
\end{tabular}
\end{center}
