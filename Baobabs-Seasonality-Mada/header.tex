...
\title[Baobabs]{Not all species will migrate poleward as the climate warms: the case of the seven baobab species in Madagascar.}
%\subtitle{} 
...
\logo{\ifplacelogo\includegraphics[width=0.3\textwidth]{figs/partners_logos}\fi} % replace with your own command
