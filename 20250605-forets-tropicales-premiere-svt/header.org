...
#+BEAMER_HEADER: \usepackage[french,english]{babel}
...
#+BEAMER_HEADER: \logo{\ifplacelogo\includegraphics[width=0.4\textwidth]{figs/partners_logos}\fi}
#+BEAMER_HEADER: 
...
#+BEAMER_HEADER:     \frametitle{Plan de la présentation}
