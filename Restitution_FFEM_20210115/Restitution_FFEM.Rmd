...
- Plantes vasculaires: 12000 espèces, 85 d'endémisme
- Arbres: 96% d'endémisme
- Caméléons: la moitié des espèces au monde
- Lémuriens: 110 espèces, 100% d'endémisme
...
- Base de données de **biodiversité** incluant plus de 300 000 points de présences pour 4969 espèces représentatives de la biodiversité à Madagascar. Cette base de données, incluant des données privées, est intégrée à la base ReBioMa gérée par le WCS Madagascar (<https://www.rebioma.org/>).
